 ...
 */
export function replaceStylesheetLinkElement (parent, stylesheetLinkElementAttributes) {
  ...
  parent.appendChild(createStylesheetLinkElement(stylesheetLinkElementAttributes))
}
