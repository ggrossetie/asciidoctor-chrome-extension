import {
  ...
  getRemotePollFrequency, getSetting,
  isExtensionEnabled, isLiveReloadDetected,
  isTxtExtAllowed
...
async function startAutoReload () {
  ...
  const pollFrequency = remoteFile ? await getRemotePollFrequency() : await getLocalPollFrequency()
